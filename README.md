...
- [Fabric8](http://fabric8.io/) - Open source Microservices Platform based on [Docker](https://www.docker.com/), [Kubernetes](http://kubernetes.io/) and [Jenkins](https://jenkins.io/) to make it easy to create, edit, deploy and manage microservices with [Continuous Delivery](http://fabric8.io/guide/cdelivery.html).
